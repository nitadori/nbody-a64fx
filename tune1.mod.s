...
// (13) /*    103 */	ldp	s10, s9, [x8, -8]	//  (*)
/* (13) */	add	x8, x8, -8
// /* (13) */	ldr	s10, [x8]	//  (*)
// /* (13) */	ldr	s9, [x8, 4]	//  (*)
/* (13) */	ld1rw	{z10.s}, p0/z, [x8]	//  (*)
/* (13) */	ld1rw	{z9.s}, p0/z, [x8, 4]	//  (*)
/* (13) */	add	x8, x8, 8
...
/*     45 */	fmul	z4.s, z11.s, z17.s
	.loc 1 103 0
..LDL61:
// (13) /*    103 */	dup	z10.s, z10.s[0]
	.loc 1 104 0
..LDL62:
// (14) /*    104 */	dup	z9.s, z9.s[0]
	.loc 1 88 0
..LDL63:
...
// (10) /*     88 */	dup	z11.s, z13.s[0]
	.loc 1 89 0
..LDL132:
// (11) /*     89 */	ldr	s10, [x11, 28]	//  (*)
	.loc 1 117 0
..LDL133:
// (11) /*    117 */	add	x11, x11, 48 // moved later, x13 = x11 - 16
	.loc 1 98 0
..LDL134:
/*     98 */	fmad	z6.s, p0/m, z6.s, z7.s
	.loc 1 87 0
..LDL135:
// (11) /*     87 */	ldr	s12, [x11, -12]	//  (*)
// (11) /*     87 */	ldr	s12, [x11, 36]	//  (*)
/*    (12) */	ld1rw	{z12.s}, p0/z, [x11, 36]	//  (*)
	.loc 1 54 0
..LDL136:
...
/*    (11) */	ld1rw	{z14.s}, p0/z, [x11, 28]	//  (*)
/*    117 */	add	x11, x11, 48 // (11, 12)
	.loc 1 49 0
..LDL143:
...
..LDL147:
// (13) /*    103 */	ldr	s10, [x8, -8]	//  (*)
/*    (13) */	ld1rw	{z10.s}, p0/z, [x8, 40]	//  (*)
	.loc 1 87 0
..LDL148:
// (12) /*     87 */	dup	z12.s, z12.s[0]
	.loc 1 104 0
..LDL149:
// (14) /*    104 */	ldr	s9, [x8, -4]	//  (*)
/*    (14) */	ld1rw	{z9.s}, p0/z, [x8, 44]	//  (*)
/*    (14) */	add	x8, x8, 48
	.loc 1 88 0
..LDL150:
// (15) /*     88 */	ldr	s13, [x11, -8]	//  (*)
...
/*    (15) */	ld1rw	{z15.s}, p0/z, [x13, 8]	//  (*) // x13 = x11 - 16
	.loc 1 42 0
..LDL152:
/*     42 */	frsqrte	z17.s, z6.s
	.loc 1 113 0
